...
#load the usa boundaries to subset spatially
...
usa1 <-
  wsim_deficit |> dplyr::slice(time, 1)

# extract the values into a data.frame
usa1<-as.data.frame(as.numeric(wsim_deficit$deficit))
