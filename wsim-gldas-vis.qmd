...
For this example we’ll classify the WSIM-GLDAS deficit return period raster layer into 6 categories. Binning the data will make it easier to manage the output and interpret the results.
