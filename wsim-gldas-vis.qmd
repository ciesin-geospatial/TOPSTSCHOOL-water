...
extracted_df <- stars::as.data.frame(extracted_vals)
print(extracted_df)
...
gpw <- stars::read_stars("gpw_v4_population_count_rev11_15_min.nc", proxy = FALSE)
print(gpw)
