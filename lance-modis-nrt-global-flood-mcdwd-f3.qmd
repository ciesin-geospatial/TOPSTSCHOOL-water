...
url = r"https://pdi.scinet.usda.gov/image/rest/services/CDL_WM/ImageServer"
...
```{r}
breaks <- c(0, 3)
plot(flood_areas, breaks=breaks, downsample = 10)
```
...
```
```{r}
crop_type_subset <- cdl[bm_m == 3]

```
## In this Lesson, You Learned...

```{r}
plot(crop_type_subset)
