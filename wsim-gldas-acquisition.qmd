...
In this lesson, you will acquire water security data (WSIM-GLDAS) from the NASA SEDAC website and will also retrieve geoBoundaries data directly from an API.
You will learn how to subset data for a region of interest and save subsetted data as a new file.
...
We will work with the composite anomolies integrated over 1 month periods.

A raster is a grid of geographic data which has information stored per pixel.
Vectors are a collection or a list of numbers.
...
The drought subsequently dried out rivers which hosted populations of the Chinook salmon, affecting the population.
That in turn affected Native American tribes food supply. [@NationalPublicRadio2014]
...
You can also download vectorized boundaries directly from [ ](www.geoboundaries.org).
...
The drought was further exacerbated by high temperatures related to climate change in February of 2013.
...
The most devastating wildfire occurred in Bastrop County, in which 34,000 acres and 1,300 homes were destroyed.
...
-   Use libraries such as dplyr and lubridate for temporal subsetting.
