...
Once you've completed the download and placed the `composite_12mo.nc` file into your working directory and read the file with the `stars::read_stars()` function.
