...
keeps
# subset the wsim_gldas object w/ keep
...
Although **matplot.lib** is the more "python" way to plot, we are going to use the python version of R's popular **ggplot2** package. It's a simpler code structure, and will keep synergy between the R and Python versions of this lesson.
